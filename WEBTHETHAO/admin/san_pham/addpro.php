            ...
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <div class="tile-body">
                        ...
                        <form class="row" action="index.php?act=addpro" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input class="form-control" type="text" name="ten_sanpham">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="exampleSelect1" class="control-label">Danh mục</label>
                                <select class="form-control" name="ma_loai" style="padding: 3px; font-size: 1vw;">
                                    <?php
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input class="form-control" type="text" name="gia_cu"><br><br>
                            </div>
                            <div class="form-group col-md-3">
                                <label class="control-label">Giá mới</label>
                                <input class="form-control" type="text" name="don_gia"><br><br>
                            </div>
                    ...
                    <label>
                        ...
                        <a href="index.php?act=listpro"><input class="btn btn-save" type="button" name="" id="" value="Danh sách"></a>
                    </label>
                    </form>
                </div>
    </main>
