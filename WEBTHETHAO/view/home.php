                                    ...
                                    <div class="">
                                        <div class="">
                                            <form action="index.php?act=addtocart" method="POST">
                                                ...
                                                <i class="fas fa-shopping-cart text-primary mr-1"></i><input type="submit" name="addtocart" class=" btn btn-sm text-dark p-0  btn btn-default add-to-cart"  value="Giỏ hàng" >
                                            </form>
                                        </div>
                                    </div>
