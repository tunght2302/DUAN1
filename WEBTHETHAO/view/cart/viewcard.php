    ...
    <div class="row px-xl-5">
        <div class=" table-responsive mb-5" style="text-align:center ;">
            <table class="table table-bordered text-center mb-0">
                ...
                ?>
                    ...
                    <p style="color:red"><?php if (isset($_SESSION['loi'])) {
                                                echo $_SESSION['loi'];
                                            }
                                            unset($_SESSION['loi']);
                                            ?></p>
                ...
                <span style="color: red;">
                    <?php if (isset($_SESSION['chua_co_sp'])) {
                        echo $_SESSION['chua_co_sp'];
                    } ?>
                </span>
            </table>
        </div>
        <div class="input-group">
            <div class="input-group-append">
                <?php unset($_SESSION['chua_co_sp']); ?>
                <a href="index.php?act=bill" style="margin-right:30px;"><button class="btn btn-primary" name="dathang">Đặt hàng</button></a>
                <?php $thongbao ?>
